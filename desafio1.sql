...
CREATE TABLE SpotifyClone.`historico` (
    ...
    FOREIGN KEY (music_id) REFERENCES `cancoes` (music_id),
...
INSERT INTO SpotifyClone.album(nome, release_year, artist_id)
...
INSERT INTO SpotifyClone.cancoes(nome, album_id, duration, artist_id)
...
INSERT INTO SpotifyClone.historico(user_id, music_id, date, hour)
...
INSERT INTO SpotifyClone.seguidores(user_id, artist_id)
	VALUES(1, 1),
		  (1, 4),
          (1, 3),
          (2, 1),
